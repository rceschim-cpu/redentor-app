...
const styles = StyleSheet.create({
  ...
  dateNum: { fontSize: 22, fontWeight: '700', color: Colors.primary, fontFamily: 'Lora_600SemiBold', lineHeight: 26 },
  dateMon: { fontSize: 9, fontWeight: '700', color: Colors.textMuted, textTransform: 'uppercase', letterSpacing: 0.5 },
  eventBody: { flex: 1, gap: 3 },
  eventTitle: { fontSize: 14, fontWeight: '700', color: Colors.textPrimary, fontFamily: 'Lora_600SemiBold' },
